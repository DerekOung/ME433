                    ...
                    case 2:
                        ...
                        if(appData.hidDataTransmitted)
                        {
                            ...
                            if(_CP0_GET_COUNT()<800000){
                                ...
                                // for (i=0; i<=2; i++){
                                    accelerometer_data[0] = accels[2] & 0xff;
                                    appData.transmitDataBuffer[2] = accelerometer_data[0];
                                    accelerometer_data[1] = (accels[2]>>8) & 0xff;
                                    appData.transmitDataBuffer[3] = accelerometer_data[1];
                                // }
                                _CP0_SET_COUNT(0);
                            }
                        }
